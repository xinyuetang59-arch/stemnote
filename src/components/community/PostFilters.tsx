...
export default function PostFilters() {
  const { filters, setFilter, clearFilters } = usePostStore();

  const hasFilters = filters.school || filters.type;
    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl p-4 shadow-sm border border-slate-100 dark:border-slate-700">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          className="text-sm border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-1.5 bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-gold/30"
        >
